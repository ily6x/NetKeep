...
class Ticket
{
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * FROM tickets WHERE id_auteur = :id ORDER BY date_creation DESC');
    ...
    public function assignerTechnicien(int $id_ticket, int $id_technicien): bool
    {
        $stmt = $this->pdo->prepare(
            'UPDATE tickets
             SET id_technicien = :id_technicien, statut = :statut
             WHERE id = :id'
        );
    ...
    public function resoudre(int $id, string $message_resolution, int $id_technicien): bool
    {
        $stmt = $this->pdo->prepare(
            'UPDATE tickets
             SET statut = :statut, message_resolution = :message, id_technicien = :id_technicien
             WHERE id = :id'
        );
